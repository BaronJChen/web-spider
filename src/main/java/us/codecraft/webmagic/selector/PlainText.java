...
public class PlainText extends AbstractSelectable {
    ...
    public static us.codecraft.webmagic.selector.PlainText create(String text) {
        return new us.codecraft.webmagic.selector.PlainText(text);
    }
